...
static int afe4400_decoder_get_frame_count(const uint8_t *buffer,
...
static int afe4400_decoder_get_size_info(struct sensor_chan_spec chan_spec, size_t *base_size,
										  size_t *frame_size)
{
...
static int afe4400_decoder_decode(const uint8_t *buffer, struct sensor_chan_spec chan_spec,
