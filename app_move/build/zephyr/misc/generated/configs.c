...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEALTHYPI_USB_CDC_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEALTHYPI_DISPLAY_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MAXIM_MAX30001_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_MAXIM_MAX30205_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_WAVESHARE_GC9A01A_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_MAX30001, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_MAX30001_INIT_PRIORITY, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_MAX30205, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_AFE4400, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_AFE4400_INIT_PRIORITY, 80);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SENSOR_MAX32664, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_GC9A01A, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HEALTHYPI5_ZEPHYR_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_CIRCLE_CACHE_SIZE, 8);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_FONT_MONTSERRAT_34, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LV_USE_FONT_SUBPX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_HEALTHYPI_FIT_NRF5340_CPUAPP, 1);
